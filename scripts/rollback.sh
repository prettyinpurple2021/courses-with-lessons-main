...
echo "   git push origin $CURRENT_BRANCH --force"
echo ""
echo "3. Rollback via Render Dashboard"
echo "   - Go to Render Dashboard > Your Service"
echo "   - Click on 'Manual Deploy'"
echo "   - Select previous successful deployment"
echo "   - Click 'Deploy'"
echo ""
echo "4. Rollback Database (if needed)"
echo "   - Go to Render Dashboard > PostgreSQL"
echo "   - Use 'Point-in-Time Recovery' if available"
